...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['turnover_ratio',"PB","intang_assets","goodwill","tot_assets","oper_rev","total_share","net_cash_flows_oper_act","tot_profit","tot_non_cur_assets"]
    check_factor = ','.join(factor_list)
    
    dataview_folder = r'/Users/chenchao/Documents/internquant/data'
...
from Tamplate_8 import alpha126,alpha166,Volatility,IntangibleAssetRatio,OperatingRevenuePS,OperatingNIToTPLatest,CurrentAssetsRatio
#计算pb的数据缺失
for f in ['alpha126','alpha166','Volatility','IntangibleAssetRatio','OperatingRevenuePS','OperatingNIToTPLatest','CurrentAssetsRatio']:
